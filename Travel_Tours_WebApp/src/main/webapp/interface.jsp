        ...
        <div class="wrapper" onclick="void(0);">
            ...
            <header class="c-header type_breadcrumb  " id="header">
                <div class="c-header__left">
                    <div class="c-header__logo">
                        <a href="https://forevervacation.com"><img class="pc-only" src="images/1.png" alt="logo" loading="lazy">
                            <img class="sp-only" src="images/logo_header_mobile_new.svg" alt="logo" loading="lazy">
                        </a>
                    </div>
                ...
                <div class="c-header__right" data-navigation="">
                        ...
                        <nav class="navigation">
                            <div class="navigation__head">
                                ...
                                <div btn-close-menu="" class="navigation__closebtn">
                                    <img src="images/icon_close_black.svg" alt="close-icon" loading="lazy">
                                </div>
                            </div>
                            ...
                            <ul class="navigation__menumain">
                                <li class="navigation__menumain__item">
                                    <a class="navigation__menumain__item__destinations" data-btn-drop-down=""><span
                                        ...
                                        Destinations
                                        <img src="images/arrow-right.svg" alt="arrow-right" loading="lazy">
                                    </a>
                                                ...
                                                <div data-submenu-sp="" class="navigation__submenu__inner">
                                                    <div class="navigation__submenu__head">
                                                        <div class="navigation__submenu__head__back" data-btn-prev="">
                                                            <img src="images/Arrow-left-news.svg" alt="arrow-left" loading="lazy">
                                                        </div>
                                                        ...
                                                        <div btn-close-menu="" class="navigation__closebtn">
                                                            <img src="images/Icon-Close-news.svg" alt="close-icon" loading="lazy">
                                                        </div>
                                                    </div>
                    ...
                    <div class="c-header__group">
                        ...
                        <div class="c-header__user-not-login pc-only">
                            <div class="c-header__user-menu">
                                <div class="c-header__user-toggle" data-slide-toggle="">
                                    ...
                                    <img src="images/arrow-down-white.svg" alt="Expand menu" class="c-header__user-arrow">
                                </div>
                        ...
                        <a href="https://wa.me/16174042125" target="_blank" class="c-header__contact">
                            ...
                            <p>
                                <img src="images/whatsapp.svg" alt="whatsapp" loading="lazy">0384 123 254
                            </p>
                        </a>
                    </div>
                </div>
            ...
            <main class="destination">
                <picture class="bg-map lazyload">
                    <source type="image/png" srcset="images/map.png">
                    <source type="image/png" srcset="images/map.png">
                    <img src="images/map.png" alt="map">
                </picture>
                <section class="tour_in_KV">
                    <picture class="tour_in_KV__bg lazyload">
                        <source type="image/png" media="(min-width: 769px)" srcset="images/3.jpg">
                        <source type="image/png" media="(max-width: 768px)" srcset="images/3.jpg">
                        <img src="images/bali.webp" alt="banner">
                    </picture>
                    <div class="tour_in_KV__brush">
                        <img src="images/brush-stroke.svg" alt="brush-stroke">
                    </div>
                    <div class="tour_in_KV__main">
                        <div class="c-container">
                            ...
                            <a href="#Tours" class="c-btn01">See All Our Tours<img src="images/Icon-Plane.svg" alt="ic-plane"></a>
                            <p class="c-text01">Over 20,000 Reviews</p>
                            <div class="tour_in_KV__gr">
                                <dl>
                                    <dt>
                                        <img src="images/2.png" alt="tripadvisor">
                                    </dt>
                                    <dd>
                                        <div class="tour_in_KV__gr__star">
                                            <img src="images/icon-rounded.svg" alt="rounded">
                                            <img src="images/icon-rounded.svg" alt="rounded">
                                            <img src="images/icon-rounded.svg" alt="rounded">
                                            <img src="images/icon-rounded.svg" alt="rounded">
                                            <img src="images/icon-rounded.svg" alt="rounded">
                    ...
                    <div class="c-container">
                                ...
                                <div class="dropdown__box">
                                    ...
                                    <div class="dropdown__btn">
                                        ...
                                        <img class="lazyloaded"
                                             ...
                                             alt="arrow-down" src="images/Icon-Arrow-Right-2.svg">
                                    </div>
                                </div>
                        ...
                        <div class="c-gr_filter">
                            <div class="c-gr_filter__item" data-filter="">
                                <img class="lazyloaded" src="images/new-filter.svg" alt="filter">
                                <p>City Tours</p>
                            </div>
                    ...
                    <div class="destination__sec02__inner">
                        ...
                        <div class="main_content">
                            <ul class="c-list_tour01" id="desktop_tour_top_tours_section">
                                       ...
                                       class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)"
                                                    srcset="images/bali-instagram-tour-the-most-famous-spots-3509_1.jpg">
                                            <source type="image/png" media="(max-width: 768px)"
                                                    srcset="images/bali-instagram-tour-the-most-famous-spots-3509.jpg">
                                            <img src="images/bali-instagram-tour-the-most-famous-spots-3509.jpg"
                                    ...
                                    <div class="c-list_tour01__cont">
                                        ...
                                        <div class="c-list_tour01__bottom">
                                            ...
                                            <picture class="lazyload">
                                                <source type="image/png" media="(min-width: 769px)" srcset="images/clock-tour.png">
                                                <source type="image/png" media="(max-width: 768px)" srcset="images/clock-tour.png">
                                                <img src="images/clock-tour.png" alt="clock-yellow">
                                            </picture>
                                            13 hours
                                            </p>
                                            <p class="c-list_tour01__inclusive">
                                                <img src="images/star-tour.png" alt="clock-yellow">All-inclusive
                                            </p>
                                            <p class="c-list_tour01__inclusive">
                                                <img src="images/client-tour.png" alt="clock-yellow">Private Tour
                                            </p>
                                            <a href="https://forevervacation.com/tours-in-bali/city-tours"
                                ...
                                <li class="c-list_tour01__item">
                                    <a href="https://forevervacation.com/bali-unesco-world-heritage-sites-tour"
                                       class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)" srcset="images/best-of-ubud-tour-2630_1.jpg">
                                            <source type="image/png" media="(max-width: 768px)" srcset="images/best-of-ubud-tour-2630.jpg">
                                            <img src="images/best-of-ubud-tour-2630.jpg" alt="Bali Unesco World Heritage Sites Tour          ">
                                        </picture>
                                    </a>
                                    <div class="c-list_tour01__cont">
                                        <div class="c-list_tour01__top">
                                ...
                                <li class="c-list_tour01__item">
                                    <a href="https://forevervacation.com/bali-ultimate-monkey-forest-tour" class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)"
                                                    srcset="images/ultimate-monkey-forest-tour-3826_1.jpg">
                                            <source type="image/png" media="(max-width: 768px)"
                                                    srcset="images/ultimate-monkey-forest-tour-3826.jpg">
                                            <img src="images/ultimate-monkey-forest-tour-3826.jpg" alt="Bali Ultimate Monkey Forest Tour">
                                        </picture>
                                    </a>
                                    <div class="c-list_tour01__cont">
                                        <div class="c-list_tour01__top">
                                ...
                                <li class="c-list_tour01__item">
                                    <a href="https://forevervacation.com/bali-best-of-ubud-tour" class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)" srcset="images/besakih-mother-temple_1.jpg">
                                            <source type="image/png" media="(max-width: 768px)" srcset="images/besakih-mother-temple.jpg">
                                            <img src="images/besakih-mother-temple.jpg" alt="Best of Ubud Tour ">
                                        </picture>
                                    </a>
                                    <div class="c-list_tour01__cont">
                                        <div class="c-list_tour01__top">
                                ...
                                <li class="c-list_tour01__item">
                                    <a href="https://forevervacation.com/balinese-cooking-class-tanah-lot-temple-visit"
                                       class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)"
                                                    srcset="images/balinese-cooking-class-tanah-lot-temple-visit4_1.jpg">
                                            <source type="image/png" media="(max-width: 768px)"
                                                    srcset="images/balinese-cooking-class-tanah-lot-temple-visit4.jpg">
                                            <img src="images/balinese-cooking-class-tanah-lot-temple-visit4.jpg"
                                ...
                                <li class="c-list_tour01__item">
                                    <a href="https://forevervacation.com/bali-uluwatu-instagram-tour-unforgettable-beaches"
                                       class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)"
                                                    srcset="images/uluwatu-instagram-tour-unforgettable-beaches7_1.jpg">
                                            <source type="image/png" media="(max-width: 768px)"
                                                    srcset="images/uluwatu-instagram-tour-unforgettable-beaches7.jpg">
                                            <img src="images/uluwatu-instagram-tour-unforgettable-beaches7.jpg"
                                ...
                                <li class="c-list_tour01__item">
                                    <a href="https://forevervacation.com/bali-uluwatu-kecak-dance-tour-half-day"
                                       class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)"
                                                    srcset="images/uluwatu-kecak-dance-tour-half-day-3165_1.jpeg">
                                            <source type="image/png" media="(max-width: 768px)"
                                                    srcset="images/uluwatu-kecak-dance-tour-half-day-3165.jpeg">
                                            <img src="images/uluwatu-kecak-dance-tour-half-day-3165.jpeg"
                                ...
                                <li class="c-list_tour01__item">
                                    <a href="https://forevervacation.com/bali-private-airport-pick-up-service" class="c-list_tour01__photo">
                                        <picture>
                                            <source type="image/png" media="(min-width: 769px)"
                                                    srcset="images/bali-private-airport-pick-up-service-2376_1.jpg">
                                            <source type="image/png" media="(max-width: 768px)"
                                                    srcset="images/bali-private-airport-pick-up-service-2376.jpg">
                                            <img src="images/bali-private-airport-pick-up-service-2376.jpg"
                                    ...
                                    <div class="c-nav_01__item swiper-slide">
                                        <figure class="c-nav_01__image">
                                            <img class="ls-is-cached lazyloaded"
                                                 ...
                                                 alt="tripadvisor" src="images/Icon-awesome-tripadvisor.svg">
                                        </figure>
                                    ...
                                    <div class="c-nav_01__item swiper-slide">
                                        <figure class="c-nav_01__image">
                                            <img class="custom ls-is-cached lazyloaded"
                                                 ...
                                                 alt="Icon-Money" src="images/Icon-Money.svg">
                                        </figure>
                                    ...
                                    <div class="c-nav_01__item swiper-slide">
                                        <figure class="c-nav_01__image">
                                            <img class="custom ls-is-cached lazyloaded"
                                                 ...
                                                 alt="Icon-Support" src="images/Icon-Support.svg">
                                        </figure>
                            ...
                            <div class="loading-container" style="text-align: center">
                                <img class="loading_spinner" src="images/spinner-yellow-sm.svg" alt="Loading Tours" style="display: none">
                            </div>
                        </div>
                    </div>
                </section>
                <section class="sec_contact_move">
                    <picture class="sec_contact_move__bg lazyload">
                        <source type="image/png" media="(min-width: 768px)" srcset="images/banner.png">
                        <source type="image/png" media="(max-width: 768px)" srcset="images/new-email-banner.webp">
                        <img src="images/banner.png" alt="new-bg-top-v2">
                    </picture>
                        ...
                        <div class="c-container">
                            ...
                            <div class="sec_contact_move__group">
                                <div class="sec_contact_move__group__img">
                                    <img src="images/add-to-cart-big-brush.svg">
                                </div>
                                <p class="c-title01">
                                        ...
                                        <div class="c-list" data-toggle-position="destination">
                                            <div class="c-item">
                                                ...
                                                <div class="c-content" style="display: none">
                                                    ...
                                                    <p dir="ltr"><img src="images/1594382411.jpg" style="width: 400px;" class="fr-fic fr-dib"
                                                                      alt="bali taxis"></p>
                                                    <p dir="ltr"><br></p>
                                                    <p dir="ltr">2. With our tours you get your own personal driver and tour guide included in the
                                                        price!�</p>
                                                    <p dir="ltr"><img src="images/1594382471.jpg" style="width: 400px;" class="fr-fic fr-dib"
                                                                      alt="forevervacation tour guide"></p>
                                                    <p dir="ltr"><br></p>
                                                    <p dir="ltr">3. Denpasar is the capital city and the largest in Bali</p>
                                                    <p dir="ltr"><img src="images/1594382536.jpg" style="width: 400px;" class="fr-fic fr-dib"
                                                                      alt="denpasar bali"></p>
                                                    <p dir="ltr"><br></p>
                                                    <p dir="ltr">4. Ubud is the place to go for lush green rice fields and waterfalls</p>
                                                    <p dir="ltr"><img src="images/1594382597.jpg" style="width: 400px;" class="fr-fic fr-dib"
                                                                      alt="ubud bali"></p>
                                                    <p dir="ltr"><br></p>
                                                    <p dir="ltr">5. Kuta/Seminyak are the busiest beach cities�</p>
                                                    <p dir="ltr"><img src="images/1594382650.jpg" style="width: 400px;" class="fr-fic fr-dib"
                                                                      alt="seminyak bali"></p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <footer class="c-footer lazyload ">
                <div class="c-footer__top">
                    <picture class="c-footer__top__bg lazyload">
                        <source type="image/png" media="(min-width: 768px)" srcset="images/Footer-Image.png">
                        <source type="image/png" media="(max-width: 768px)" srcset="images/footer-bg-mobile.webp">
                        <img src="images/Footer-Image.png" alt="new-bg-top-v2">
                    </picture>
                    <div class="c-footer__logo">
                        <a href=""><img class="lazyload"
                                        data-src="https://cdn.forevervacation.com/layout_v_3/assets/img/common/pc/Logo-footer.svg"
                                        src="images/Logo-footer.svg" alt="Logo-footer"></a>
                    </div>
